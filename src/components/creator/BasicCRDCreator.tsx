...
export const BasicCRDCreator = ({ onBack }: BasicCRDCreatorProps) => {
  ...
  const handleSave = async (publish = false) => {
    ...
    if (cardId && publish) {
      // Could navigate to card view here
      onBack();
    }
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex gap-3">
            ...
            <Button 
              className="bg-[#00C851] hover:bg-[#00A543]"
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="content" className="space-y-4">
                <Card className="bg-gray-900/50 border-gray-800">
                  <CardHeader>
                    <CardTitle className="text-white">Card Content</CardTitle>
                  </CardHeader>
              ...
              <TabsContent value="image" className="space-y-4">
                <Card className="bg-gray-900/50 border-gray-800">
                  <CardHeader>
                    <CardTitle className="text-white">Card Image</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <ImageUpload
              ...
              <TabsContent value="style" className="space-y-4">
                <Card className="bg-gray-900/50 border-gray-800">
                  ...
                  <CardContent className="space-y-6">
                    {/* Color Themes */}
                    <div>
                      <Label className="text-gray-300 mb-3 block">Color Themes</Label>
                    ...
                    <div>
                      ...
                      <Slider
                        ...
                        className="mt-2"
                      />
                      <p className="text-sm text-gray-400 mt-1">{cardData.designConfig.borderRadius}px</p>
                    </div>

                    {/* Effects */}
                    <div>
                      <Label className="text-gray-300 mb-3 block">Visual Effects</Label>
                          ...
                          return (
                            <Badge
                              ...
                              className={`cursor-pointer ${
                                enabled ? "bg-[#00C851] hover:bg-[#00A543] text-white" : "border-gray-600 text-gray-400 hover:border-gray-500"
                              }`}
                              onClick={() => updateDesignConfig({
                                effects: {
                      ...
                      {(cardData.designConfig.effects.holographic || cardData.designConfig.effects.foil || cardData.designConfig.effects.chrome) && (
                        <div>
                          <Label className="text-gray-300">Effect Intensity</Label>
                          <Slider
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-gray-900/50 border-gray-800">
              ...
              <CardContent className="space-y-3">
                <Button 
                  className="w-full bg-[#00C851] hover:bg-[#00A543]"
                  onClick={() => handleSave(true)}
                  disabled={isLoading || !cardData.title.trim()}
                >
